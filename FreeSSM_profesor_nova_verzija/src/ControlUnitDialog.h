...
private:
	...
	QPushButton *_connect_pushButton;
	...
	bool _setup_done;
	bool _connected;
	bool _handlingCommunicationLoss;
	bool _communicationErrorActive;
	Mode _mode;
	ContentSelection _startupContentSelection;
	QString _startupMBSWselectionFile;
	bool _startupAutostart;
	...
	bool initializeControlUnit(Mode mode, bool showSuccessMessage = true);
	void applyMBSWStartupParameters(ContentSelection csel);
	void handleCommunicationLoss();
	void setDisconnectedState(QString message);
