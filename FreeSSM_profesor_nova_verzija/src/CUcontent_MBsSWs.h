...
private:
	...
	QString autoMBSWselectionFileName() const;
	void saveAutoMBSWselection();
	void loadAutoMBSWselection();
	QString logDirectoryName() const;
	bool openMBSWlog();
	void closeMBSWlog();
	void writeMBSWlogRow(const std::vector<unsigned int>& rawValues, const std::vector<QString>& valueStrList,
